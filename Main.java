...
import Train_Ticket_Booking.Tools.BookingSystem;
import Train_Ticket_Booking.Tools.Passenger;
import Train_Ticket_Booking.Tools.Ticket;
import Train_Ticket_Booking.Tools.Train;
...
public class Main {
    public static void main(String[] args) {
        ...
        bookingSystem.addTrain(new Train(101, "Express 1", "City A", "City B", 100));
        bookingSystem.addTrain(new Train(102, "Express 2", "City C", "City D", 50));
        bookingSystem.addTrain(new Train(103, "Express 3", "City E", "City F", 75));
